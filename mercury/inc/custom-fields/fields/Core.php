...
class Fourcrowns_Core {
    ...
    public static function load_assets() {
        wp_enqueue_style('custom-fields', get_template_directory_uri() . '/inc/custom-fields/assets/admin/admin.css', []);
        wp_enqueue_script('fourcrowns-admin-js', get_template_directory_uri() . '/inc/custom-fields/assets/admin/admin.js', ['jquery'], '6', true);
